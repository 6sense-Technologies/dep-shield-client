    ...
    return (
        <div className="pt-6 px-4 md:pt-6 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="w-full max-w-[560px]">
                <p className="text-deepBlackColor text-[16px] font-medium flex items-center gap-x-2 border-b pb-4 cursor-pointer">NVD <span><ExternalLink size={20} /></span></p>
            ...
            <div className="w-full max-w-[560px]">
                <p className="text-deepBlackColor text-[16px] font-medium flex items-center gap-x-2 border-b pb-4 cursor-pointer">GitHub <span><ExternalLink size={20} /></span></p>
